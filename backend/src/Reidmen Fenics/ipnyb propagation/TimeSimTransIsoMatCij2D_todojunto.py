...
#     def inside1(self, x, on_boundary):
#         print("jaja")
...
nsens = 1# Number of sensors separated at 0.4081 mm # RECEPTORES
...
filename = 'Files_mat/TimeSimP'+str(por+1)+'TransIsoW'+            str(ylim)+'M'+str(size) + 'MALDITOTEST'
...
#tiempo_final_10 = time()
#tiempo_ejecucion_10 = tiempo_final_10 -tiempo_inicio_10
#print("Tiempo ejecución 10:", tiempo_ejecucion_10)
